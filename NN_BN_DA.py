...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_5.setGeometry(QtCore.QRect(11, 285, 1100, 16))
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
       
        self.line_6 = QtWidgets.QFrame(self.centralwidget)
        self.line_6.setGeometry(QtCore.QRect(3, 120, 20, 170))
        self.line_6.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.line_7 = QtWidgets.QFrame(self.centralwidget)
        self.line_7.setGeometry(QtCore.QRect(190, 120, 20, 170))
...
"color:rgb(170, 0, 127);")
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 170, 150, 21))
        self.label_3.setObjectName("label_3")
        self.label_3.setStyleSheet("font: 7pt \"Impact\";\n"
"color:rgb(0, 0, 127);")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(20, 210, 160, 21))
        self.label_4.setObjectName("label_4")
        self.label_4.setStyleSheet("font: 7pt \"Impact\";\n"
"color:rgb(0, 0, 127);")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(20, 250, 150, 31))
        self.label_5.setObjectName("label_5")
        self.label_5.setStyleSheet("font: 7pt \"Impact\";\n"
"color:rgb(0, 0, 127);")
        self.line_8 = QtWidgets.QFrame(self.centralwidget)
        self.line_8.setGeometry(QtCore.QRect(333, 120, 21, 170))
...
"color:rgb(170, 0, 127);")
        ...
        self.label_t3.setGeometry(QtCore.QRect(200, 250, 131, 31))
        self.label_t3.setObjectName("label_t3")

        self.line_9 = QtWidgets.QFrame(self.centralwidget)
        self.line_9.setGeometry(QtCore.QRect(660, 120, 20, 170))
        self.line_9.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_9.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_9.setObjectName("line_9")
        self.line_10 = QtWidgets.QFrame(self.centralwidget)
        self.line_10.setGeometry(QtCore.QRect(990, 120, 20, 170))
        self.line_10.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_10.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_10.setObjectName("line_10")
        self.line_11 = QtWidgets.QFrame(self.centralwidget)
        self.line_11.setGeometry(QtCore.QRect(1100, 120, 20, 170))
...
"color:rgb(170, 0, 127);")
        ...
        self.label_ap3.setGeometry(QtCore.QRect(350, 250, 231, 41))
        ...
        self.label_te3.setGeometry(QtCore.QRect(690, 250, 191, 31))
        ...
        self.result3.setGeometry(QtCore.QRect(1030, 250, 81, 31))
        self.result3.setObjectName("result3")
        self.result3.setStyleSheet("font: 10pt ;\n")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Les Top Techniques d’apprentissage "))
        self.label_2.setText(_translate("MainWindow", "Classifier"))
        self.label_3.setText(_translate("MainWindow", "Perceptron multicouche"))
        self.label_4.setText(_translate("MainWindow", "Bayes naïves multinomiales"))
        self.label_5.setText(_translate("MainWindow", "DecisionTreeClassifier"))
        ...
        #self.label_ap1.setText(_translate("MainWindow", str(d1.score(d, alphabet)*100)))
        self.label_ap1.setText(_translate("MainWindow", str(d1.score(d, alphabet)*100)))

        self.label_te1.setText(_translate("MainWindow", str(d1.score(d2, alphabet_t)*100)))
        self.label_ap2.setText(_translate("MainWindow", str(dd2.score(d, alphabet)*100)))
        self.label_te2.setText(_translate("MainWindow", str(dd2.score(d2, alphabet_t)*100)))
        self.label_ap3.setText(_translate("MainWindow", str(d3.score(d, alphabet)*100)))
        self.label_te3.setText(_translate("MainWindow", str(d3.score(d2, alphabet_t)*100)))
        ...
        self.label_t3.setText(_translate("MainWindow", str(t3.timeit(1))))
    ...
    def openFile(self):
        ...
        self.result2.setText(str(multi.predict([self.Xi]))) 
        self.result3.setText(str(multiC.predict([self.Xi]))) 

def DecisionTreeClassifier(d,alphabet):
           global descT
           descT=tree.DecisionTreeClassifier(criterion='entropy')
...
def multinomial(d,alphabet):
        ...
        multi.fit(d,alphabet)
        return multi    

def multicouche(d,alphabet):
      global multiC
      multiC=MLPClassifier(activation='logistic', alpha=0.01,max_iter=1000)
      multiC.fit(d,alphabet)
      return multiC    

def pretraitement_image():
    y1=[]
...
def temp_Apprendre()  :     
       ...
       temp_RB = timeit.Timer('multinomial(d,alphabet)','from __main__ import multinomial , d, alphabet')
       
       temp_PM = timeit.Timer('multicouche(d,alphabet)','from __main__ import multicouche , d, alphabet')
       return  temp_PM ,temp_dec,temp_RB
...
if __name__ == "__main__":
    ...
    d,alphabet=pretraitement_image()
    d2,alphabet_t=pretraitement_Test()
    
    t1,t2,t3=temp_Apprendre()
    #h1,h2,h3=taux_recA()
    d1=DecisionTreeClassifier(d,alphabet)
    dd2=multinomial(d,alphabet)
    d3=multicouche(d,alphabet)
